            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="about-content">
                        <h2 class="f-40 fw-400 wow  fadeInUp animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeInUp;">
                            The Simple <b>IDEA</b>
                        </h2>
                        <p class="wow  fadeInUp animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">
                            Evalnode is an online assessment platform that simplifies <b>eval</b>uation, examinations or any other form of assessments by offering
                            organizations an all in one assessment management platform and offering candidates a smart platform that supports growth.
                        </p>
                        <p class="wow  fadeInUp animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">
                            Our approach is to ensure you can easily carry out evaluations or be evaluated on various areas in the most simple steps ever no matter the organization or the candidate.
                        </p>
                        <p class="wow  fadeInUp animated" data-wow-duration="1.9s" style="visibility: visible; animation-duration: 1.9s; animation-name: fadeInUp;">
                            We have made assessment setup and use easy for you so that you can even issue or receive certificates or achievements based on your organizations preferences.
                        </p>
                        <div class="buttons">
