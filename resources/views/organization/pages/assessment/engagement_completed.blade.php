            ...
            <div class="col">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-6">
                        <h5 class="card-title">{{ $subject }} / Completed Assessment</h5>
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="default-ordering" class="table table-hover table-striped " style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th title="Questions Answered" class="bs-tooltip">Answered</th>
                                        <th title="Time taken to complete" class="bs-tooltip">Time Used</th>
                                    ...
                                    @forelse($engaged as $engage)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="#" title="View Successful Candidates" class="ml-3 rounded bs-tooltip">
