...
@section('content')
    ...
    <div class="layout-px-spacing">
        ...
        <div class="layout-spacing">
            <div class="">
                <h4 class="text-center mt-3">Edit {{ $assessment->title }} a new Assessment</h4>
                <p class="text-center">Ensure the assessment is not active when making updates</p>
            </div>
            <form action="{{ route('organization.update.assessments', $assessment->uuid) }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="card card-body mb-4">
                            <div class="form-row mb-4">
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control" id="inputEmail4" placeholder="Name Assessment (Exam, Test, Quiz, Examination, etc.) one word." name="global_name" value="{{ $assessment->global_name }}" autofocus required="required">
                                    @error('global_name')
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control" id="inputEmail4" placeholder="Assessment Title" name="title" value="{{ $assessment->title }}" required="required">
                                    @error('title')
                                    <span class="invalid-feedback" role="alert">
                                        {{ $message }}
                                    </span>
                            ...
                            <div class="form-row mb-4">
                                <div class="form-group col">
                                    ...
                                    <textarea type="text" class="form-control" rows="5" id="inputEmail4" placeholder="Assessment introduction" name="introduction" required="required">{{ $assessment->introduction }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-row mb-4">
                                <div class="form-group col">
                                    ...
                                    <textarea type="text" class="form-control" rows="5" id="inputEmail4" placeholder="Assessment Instructions" name="instructions" required="required">{{ $assessment->instructions }}</textarea>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="card card-body mb-3">
                            ...
                            <div class="form-group col">
                                ...
                                <div class="n-chk">
                                    <label class="new-control new-checkbox checkbox-primary">
                                        <input type="checkbox" class="new-control-input" id="timed_value" name="timed" {{ $assessment->duration!=null?'checked':'' }} onclick="handleItem('timed_value', 'timed_input')">
                                        <span class="new-control-indicator"></span>Enable Timer on this assessment
                                    </label>
                                </div>

                            </div>
                            <div class="form-row mb-4" id="timed_input" style="display: {{ !empty($assessment->duration)?'block':'none' }}">
                                <div class="form-group col">
                                    <label for="inputEmail4">Duration | Minutes (numbers) </label>
                                    <input type="text" onkeypress="return isNumberKey(event);" name="timed_value" class="form-control" autocomplete="off" placeholder="Duration in minutes" value="{{ $assessment->duration }}">
                            ...
                            <div class="form-group col">
                                ...
                                <div class="n-chk">
                                    <label class="new-control new-checkbox checkbox-primary">
                                        <input type="checkbox" class="new-control-input" id="entry_value" name="entry" {{ !empty($assessment->active_from)?'checked':'' }} onclick="handleItem('entry_value', 'entry_input')">
                                        <span class="new-control-indicator"></span>Enable a set time when this assessment can be accessed
                                    </label>
                                </div>

                            </div>
                            <div class="form-row mb-4" id="entry_input" style="display: {{ !empty($assessment->active_from)?'block':'none' }}">
                                <div class="form-group col">
                                    <label for="inputEmail4">Entry Date</label>
                                    <input type="text" name="entry_value" id="entry_field" class="form-control form-control flatpickr flatpickr-input active" autocomplete="off" placeholder="Entry Date" readonly="readonly" value="{{ !empty($assessment->active_from)?date('Y-m-d', $assessment->active_from):'' }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group col">
                                ...
                                <div class="n-chk">
                                    <label class="new-control new-checkbox checkbox-primary">
                                        <input type="checkbox" class="new-control-input" id="expiry_value" name="expiry" {{ $assessment->expiry?'checked':'' }} onclick="handleItem('expiry_value', 'expiry_input')">
                        ...
                        <div class="card card-body mb-3">
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Total questions to be answered by candidate" name="questions_allotted" value="{{ $assessment->questions_allotted }}" autocomplete="off">
                                </div>
                                <div class="form-group col-12">
                                    <label for="inputEmail4"> Attempts Allowed</label>
                                    <input type="text" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Total Attempts Allowed per candidate" name="attempts_allowed" value="{{ empty($assessment->attempts_allowed)?1:$assessment->attempts_allowed }}" >
                                </div>
                                <div class="form-group col-12">
                                    <label for="inputEmail4">* Pass Score Percentage</label>
                                    <input type="text" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Percentage score to pass question" name="pass_percent" value="{{ $assessment->pass_percent }}" required="required" autocomplete="off">
                                </div>
                                <div class="form-group col-12">
                                    <div class="n-chk">
                                        <label class="new-control new-checkbox checkbox-primary">
                                            <input type="checkbox" class="new-control-input" name="show_score" {{ $assessment->show_score?'checked':'' }} >
                                ...
                                <div class="form-group col-12">
                                    <div class="n-chk">
                                        <label class="new-control new-checkbox checkbox-primary">
                                            <input type="checkbox" class="new-control-input" name="allow_review" {{ $assessment->allow_review?'checked':'' }} >
