        ...
        <div class="col-xl-4 col-lg-6 col-md-5 col-sm-12 layout-top-spacing">
            ...
            <div class="user-profile layout-spacing">
                <div class="widget-content widget-content-area">
                    ...
                    <div class="text-center user-info">
                        <img src="{{ $person->image }}" alt="avatar" style="width: 90px;">
                        <p class="">{{ $person->names }}</p>
                    </div>
            ...
            <div class="work-experience layout-spacing ">
                ...
                <div class="widget-content widget-content-area">
                    ...
                    <p>
                        <a href="{{ route('new.organization') }}"><b>Create Organization </b>
        ...
        <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
            ...
            <div class="bio layout-spacing ">
                <div class="widget-content widget-content-area">
                    ...
                    <p>Select a theme of your choice </p>
                        ...
                        <div class="row">
                                ...
                                <a href="{{ route('switch.theme', 'light') }}">
                                    <div class="b-skills">
                                        <div class="text-center">
                                            ...
                                            <img src="{{ url('assets/svg/sun.svg') }}" alt="" style="width: 50px">
                                            <h5 class="text-center mt-3">Light Theme</h5>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-12 col-xl-6 col-lg-12 mb-xl-5 mb-5 ">
                                <a href="{{ route('switch.theme', 'dark') }}">
                                    <div class="b-skills">
                                        <div class="text-center">
                                            <img src="{{ url('assets/svg/moon.svg') }}" alt="" style="width: 50px">
                                            <h5 class="text-center mt-3">Dark Theme</h5>
                                        </div>
                                    </div>
                                </a>
                            </div>
