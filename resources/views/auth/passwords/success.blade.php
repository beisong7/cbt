...
@section('page_title', 'Password Email Success')
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="mb-2">Email not received yet?.</p>

                        <form class="text-left" action="{{ route('password.mail.org') }}" method="POST">
                            @csrf
