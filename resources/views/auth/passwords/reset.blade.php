            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="mb-0">Provide a new password.</p>

                        <form class="text-left" action="{{ !empty($type)?route('staff.password.update'):route('password.update') }}" method="POST">
                            @csrf
                            ...
                            <div class="form">
                                <div id="email-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="email" value="{{ $email ?? old('email') }}" class="form-control @error('email') is-invalid @enderror" placeholder="johndoe@mail.com" required autofocus>
                                    @error('email')
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
                                    <input id="password2" name="password_confirmation" type="password" class="form-control" placeholder="********" required autocomplete="off">
