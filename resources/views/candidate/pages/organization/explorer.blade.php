...
@section('css_plugins')
    <link rel="stylesheet" type="text/css" href="{{ asset("candidate/assets/themes/$person->theme/css/apps/notes.css") }}">
...
@section('custom_js')
    <script src="{{ asset("candidate/assets/themes/$person->theme/js/ie11fix/fn.fix-padStart.js") }}"></script>
    <script src="{{ asset("candidate/assets/themes/$person->theme/js/apps/notes.js") }}"></script>
@endsection