    ...
    <div class="layout-px-spacing">
        <div class="action-btn layout-top-spacing mb-5">
            <p>
                ...
                Assessment / {{ $engagedAssessment->assessment->title }}
            </p>
        </div>
        @include('layouts.notice')
       @include('candidate.pages.assessment._partials.resume')
...
//            console.log('answers are built');
            return `<div class="col-md-6 col-sm-12">
                      <div class="n-chk">
                        ...
                        <input type="radio" name="${question.uuid}" value="${answer.uuid}" class="new-control-input ${question.uuid}_value" ${answer.selected?'checked':''}>
